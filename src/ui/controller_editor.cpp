...
controller_editor::controller_editor(std::unique_ptr<i_img_editor> editor, std::vector<cv::Rect> faces, cv::Mat img, std::shared_ptr<view_editor> view) :
    ...
    m_view(view)
{
    ...
    m_editor->set_bounding_boxes(faces);
}
